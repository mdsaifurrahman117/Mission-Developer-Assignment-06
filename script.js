document.addEventListener("DOMContentLoaded", () => {
            ...
            const show_liked_pets = (image) => {
                        ...
                        const liked_pet = document.getElementById("liked_pets");
                        const liked_pets_container = document.createElement("div");
                        liked_pets_container.classList.add("w-[110px]","h-[80px]")
                        // console.log(image.petData.image);
                        liked_pets_container.innerHTML = `
                                    <img src="${image.petData.image}" 
                                                title="${image.petData.pet_name}" 
